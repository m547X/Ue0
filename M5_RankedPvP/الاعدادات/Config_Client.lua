...
Config.WorldBoard = {
    ...
    screens = {
        ...
        -- من كم متر تبدأ تبين. كل ما زاد الرقم زاد المدى الي تنرسم فيه.
        distance = 18.0,

        -- كم صف ينعرض بالشاشة الوحدة (من التوب الي جاي من السيرفر)
        rows     = 10,

        -- حجم اللوحة. زوّدها إذا تبيها أكبر.
        scale    = 1.0,

        -- شفافية خلفية اللوحة (٠ شفافة تماماً، ٢٥٥ معتمة)
        opacity  = 190,

        -- الأماكن. تقدر تحط كم شاشة ما تبي، كل وحدة سطر.
        --   pos     = مكان مركز اللوحة بالهواء (vector3)
        --   title   = العنوان فوق اللوحة
        --   enabled = تقدر تطفي شاشة وحدة بدون ما تحذفها
        -- ⚠ الإحداثية تحت **مثال** ما هي مكانك. لازم تغيّرها وإلا اللوحة
        -- تكون موجودة بمكان ما تروح له أبداً وتحسبها ما اشتغلت.
        -- وقف بالمكان الي تبيها فيه واكتب /pvpcoords وانسخ السطر.
        spots = {
            {
