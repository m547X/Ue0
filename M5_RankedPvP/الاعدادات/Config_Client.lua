...
-- بزاوية الشاشة فيه قبول ورفض وعدّاد، ويجيك مؤشر تقدر تضغط فيه. تقدر كمان
-- تضغط Enter عشان تقبل بدون ما تحرك الماوس أصلاً. أول ما ترد أو ينتهي
-- العدّاد، المؤشر يرجع لحاله والكارد يختفي.

Config.Prompt = {
    -- true  : تضل تتحرك وتلعب عادي والمؤشر ظاهر — ما تنجمد. هذا المطلوب
    --         بسيرفر قتال، لأن الدعوة ممكن تجيك وأنت وسط اشتباك.
    -- false : المؤشر ياخذ التحكم كامل لين ترد (يجمّدك). ما ينصح فيه إلا
    --         بسيرفرات الرول بلاي الهادية.
    keepInput = true,
