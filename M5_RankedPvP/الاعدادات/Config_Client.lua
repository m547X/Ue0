...
-- ============================================================================
-- ١١ب. زر الشات الي يرسل كود الغرفة
-- ============================================================================
-- الزر الي جنب كود الغرفة بواجهة الغرف الخاصة.

Config.RoomCodeChat = {
    enabled = true,

    -- 'say'   : يرسل الكود للشات العام عن طريق كوماند السيرفر تحت، عشان
    --           أصدقاءك يشوفونه ويدخلون فيه.
    -- 'local' : يطبع الكود بالشات لك أنت فقط، ما أحد ثاني يشوفه.
    mode = 'say',

    -- الكوماند الي يستخدمه وضع 'say'. إذا سيرفرك مقفّل /say أو عنده شات
    -- ثاني، غيّر الاسم هنا لكوماند الشات عندك.
    command = 'say',

    -- نص الرسالة. %s ينبدل بكود الغرفة.
    message = 'كود غرفة الرانك: %s',

    -- شكل السطر بوضع 'local'
    localColor = { 220, 60, 80 },
    localTitle = 'RANKED'
}
