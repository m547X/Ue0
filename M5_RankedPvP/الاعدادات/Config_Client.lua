...
Config.WorldBoard = {
    ...
    screens = {
        ...
        -- كم صف ينعرض بجدول اليمين. **التوب ٣ ما ينعادون** — هم واقفين
        -- بالبوديوم على اليسار، والجدول يكمّل من المركز الرابع وطالع.
        -- ٧ = المراكز ٤ إلى ١٠ (لازم Config.WorldBoard.top بالسيرفر يكون
        -- ٣ + هالرقم أو أكثر، وإلا الجدول ينقص).
        rows     = 7,

        -- الي ينكتب بمكان الجدول إذا ما فيه أحد يعرضه
        emptyText = 'NO RANKED PLAYERS YET',
        fewText   = 'ONLY THE TOP THREE SO FAR',
