...
Config.WorldBoard = {
    ...
    screens = {
        ...
        -- ---- مسافة الظهور --------------------------------------------------
        -- من كم متر (بالأمتار) تبدأ الشاشة تبين للاعب. لوح كبير على عمارة
        -- خلّه ٨٠ أو أكثر، ولوح صغير داخل مبنى ٢٠ تكفي.
        --
        -- هذا السطر يمشي على **كل الشاشات**، حتى الي حطيتها من داخل اللعبة
        -- بمحرّر اللوحة وانحفظت بقاعدة البيانات. يعني تغيّر الرقم هنا وترستارت
        -- وبس — ما تحتاج تعيد وضع اللوحات.
        --
        -- الاستثناء الوحيد: لو دخلت المحرّر وغيّرت "SEEN FROM" لشاشة معيّنة،
        -- هذي الشاشة تصير لها مسافتها الخاصة وما تسمع للسطر هذا بعدها. الشاشة
        -- الي لسا تابعة للكونفق يطلع جنب رقمها ·cfg بالمحرّر.
        --
        -- وتقدر تعطي شاشة من الي تحت مسافتها الخاصة بكتابة distance بسطرها.
        distance = 35.0,
        ...
        -- مقاس التكستشر بالبكسل — وهذا **أثقل شي باللوحة كلها**.
        --
        -- اللوح صفحة متصفح حقيقية، والمتصفح يحجز ذاكرة بعدد البكسلات:
        -- ١٢٨٠×٧٢٠ = ٩٢١ ألف بكسل، و٨٠٠×٤٥٠ = ٣٦٠ ألف. يعني أقل من النص.
        -- والصفحة عندنا ساكنة تماماً (بلا أنميشن ولا مؤقتات)، فبعد أول رسمة
        -- ما تكلّف معالجة — تكلّف ذاكرة فقط. عشان كذا المقاس هو الرافعة.
        --
        -- صفر = **تلقائي**: يحسب المقاس من عرض أعرض لوح عندك (١١٠ بكسل
        -- للمتر، بحد ٦٤٠ وحد أعلى ١٢٨٠، و١٦:٩ دايم). لوح بعرض ٧ أمتار
        -- ياخذ ٨٠٠×٤٥٠ بدل ١٢٨٠×٧٢٠ — نفس الوضوح من مسافة القراءة وثلث
        -- الذاكرة تقريباً. خلّها صفر إلا إذا كان عندك لوح ضخم جداً.
        textureWidth  = 0,
        textureHeight = 0,

        -- كم ثانية يضل اللوح محمّل بعد ما تبتعد عنه قبل ما تنرجّع ذاكرته.
        -- ٠ = يضل محمّل دايم (لا تسويها إلا لو اللوح بمكان الناس دايم فيه).
        -- ٣٠ ثانية تكفي إنك تلف وترجع بدون ما تنعاد الصفحة، وترجّع الذاكرة
        -- بسرعة للي مرّ ومشى.
        keepAlive = 30,
        ...
        --   distance = اختياري. مسافة ظهور خاصة بهذي الشاشة بدل distance
        --            الي فوق. مثال: لوح فوق عمارة distance = 90.0
    ...
    podium = {
        ...
        -- نفس كلام مسافة الشاشة: يمشي حتى على التماثيل المحفوظة من المحرّر،
        -- إلا إذا غيّرت "SEEN FROM" للمنصة من داخل المحرّر.
        distance = 25.0,
