...
Config.HUD = {
    ...
    scoreboard = {
        ...
        -- يطلع السكوربورد لحاله عند نهاية كل راوند. مطفي: بين الراوندات
        -- تشوف بس بانر الفوز/الخسارة والنتيجة، والسكوربورد يفتح بزر TAB
        -- وقت ما تبي. شغّله إذا تبي القديم يرجع.
        autoOnRoundEnd = false
    },
