...
--
-- `image` هي صورة المعاينة الي تطلع ببطاقات تصويت الماب.
--
-- كيف تكتب المسار — ثلاث طرق، وكلها تشير لنفس الملف Files/ui/img/harbor.png:
--
--     'harbor'            الاسم المجرّد، اختصار لملف png
--     'harbor.png'        اسم الملف، وهي طريقتك لملف jpg أو webp
--     'img/harbor.png'    المسار مكتوب كامل
--
-- وأي قيمة فيها سلاش أو بروتوكول (‎https:// أو nui:// أو data:) تنستخدم زي ما
-- هي بالضبط، فالرابط الكامل يشتغل بأي مكان يشتغل فيه الملف. والمجلدات الفرعية
-- مسموحة كمان: 'img/weapons/ak.png'.
--
-- الملف الناقص يرجع للوحة الملوّنة البديلة، فشاشة التصويت ما تنكسر بسبب صورة.
...
Config.Avatars = {
    ...
    -- تطلع كل ما ما قدرنا نجيب صورة حقيقية. أي رابط، أو ملف تحطه تحت
    -- Files/ui/img/ ‏— 'noface' أو 'noface.jpg' أو 'img/noface.png'.
...
Config.Store = {
    ...
    -- ---- البطايق -------------------------------------------------------
    -- الحقل `image` يقبل أي رابط، أو ملف تحطه تحت Files/ui/img/ — نفس الطرق
    -- الثلاث المشروحة عند Config.Maps فوق: 'card1' أو 'card1.jpg' أو
    -- 'img/card1.jpg'. المانيفست أصلاً يشحن كل الي بمجلد img.
