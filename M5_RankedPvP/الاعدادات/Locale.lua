...
Locale.ar = {
    ...
    -- عكس الي فوقه: بدل ما تجيب اللوحة لك، ينقلك أنت لها. ينزّلك قدامها
    -- وأنت تطالعها، أو جنب مكان التمثال. يفيد لما تكون اللوحة بطرف الخريطة.
    ['GO TO IT']                  = 'انتقل لها',
    -- /pvpboard test — يرسم اللوح بلون رمادي ثابت بدل صفحة المتصدرين، عشان
    -- تعرف إذا المشكلة بمكان اللوح وشكله، ولا بالصفحة الي تنرسم عليه.
    ['Drawing a plain test panel for 15 seconds.'] = 'نرسم لوح اختبار رمادي لمدة ١٥ ثانية.',

    -- شريط الحالة فوق محرّر اللوحة. كل سطر منه سبب حقيقي لكون اللوحة ما تبين
    -- وأنت حاسب إن كل شي مضبوط، فبدل ما تخمّن يقول لك وين واقف:
    --   الصفوف   = السيرفر رد وأرسل الترتيب ولا لا
    --   الشاشات  = كم شاشة بالترتيب الحالي
    --   أقرب شاشة = بعدك عنها، وهل أنت داخل مدى رؤيتها أصلاً
    ...
    ['PAGE LOADED']               = 'الصفحة محمّلة',
    ['PAGE NOT LOADED YET']       = 'الصفحة ما تحمّلت بعد',
    ['PLACED AND SAVED']          = 'محطوطة ومحفوظة',
    ['USING THE CONFIG SPOTS']    = 'تستخدم إحداثيات الكونفيق',
    ['WIDTH']                     = 'العرض',
    ['TILT']                      = 'الميلان',
    ['OPACITY']                   = 'الوضوح',
    ['STEP SIZE']                 = 'سرعة التحريك',
    ['SIZE']                      = 'الحجم',
    ['ROWS']                      = 'عدد الصفوف',
    ...
    ['ELIMINATION']               = 'إقصاء',
    -- الاثنين ذبحوا بعض — الراوند تعادل وينعاد
    ['TRADE']                     = 'تريد — ذبحتوا بعض',
    ['TIME']                      = 'انتهى الوقت',
    ['VICTORY']                   = 'فوز',
    ['DEFEAT']                    = 'خسارة',
    ['DRAW']                      = 'تعادل',
    ...
    -- تطلع بلوحة الصدارة لما ما فيه ولا لاعب عنده رانك بهذا الطور بعد.
    -- اللوحة تعرض سلّم الطور نفسه، فأي لاعب عنده RP يطلع هنا حتى لو ما لعب
    -- مباراة بعد — لو طلع هذا النص فمعناه السلّم فاضي فعلاً، مو إن اللوحة خربانة.
    ['NOBODY IS ON THIS LADDER YET'] = 'ما فيه أحد بسلّم هذا الطور بعد',
