...
-- chunkSize : حجم كل جزء يُرسل من اللاعب إلى السيرفر.
--             ⚠️ لا ترفعه فوق 15000 وإلا يطرد اللاعب برسالة
...
-- false = تلقائي، ينتظر Config.ScreenshotDelay ثم يصوّر وينتقل.
-- true  = يقف عند كل سيارة وينتظر منك:
--         Enter     = صوّر وانتقل للسيارة التالية.
--         Space     = تخطَّ هذه السيارة بدون تصوير.
--         السهم يمين/يسار = تدوير السيارة.
--         Backspace = إنهاء الجلسة.
--
--         وتقدر تتحكم بالكاميرا قبل كل لقطة:
--         WASD  = تحريك | الماوس = النظر | عجلة الماوس = زوم
--         Q / E = فوق / تحت | Shift = أسرع | R = إرجاع كاميرا المكان
--         التعديل يبقى للسيارات التالية في نفس الجلسة ولا يغيّر إعدادات
--         المكان المحفوظة (استخدم محرر الكاميرا لحفظها بشكل دائم).
--         سرعات الحركة والزوم تُؤخذ من Config.CameraEditor بالأسفل.
-- يمكن تغييره داخل اللعبة من تبويب "التصوير" في الواجهة.
Config.ManualCapture = false
